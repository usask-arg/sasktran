     ...
     &                  SPIKE )
      !DEC$ ATTRIBUTES DLLEXPORT:: MIEV0
C      !DEC$ ATTRIBUTES ALIAS:"miev0_" :: MIEV0
...
c ----------------------------------------------------------------------
      ...
      IMPLICIT  NONE
C      !DLL_EXPORT MIEV0		!  ****** Nick Lloyd ***** Lahey Fortan make this available through the DLL interface

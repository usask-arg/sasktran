...
template<int NSTOKES, int CNSTR>
void sktran_do_detail::LPTripleProduct<NSTOKES, CNSTR>::negations_derivative_emplace(uint num, sktran_do_detail::TripleProductDerivativeHolder<NSTOKES>& holder) {

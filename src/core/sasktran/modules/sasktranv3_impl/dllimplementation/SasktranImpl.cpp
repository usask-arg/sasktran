...
extern "C" DLL_PUBLIC void calculate(const sasktran_disco_lowlevel::Atmosphere* atmosphere, const sasktran_disco_lowlevel::Config* config,
...
extern "C" DLL_PUBLIC bool SKTRANIF_CreateEngine2( const char* userenginename, ISKEngine_Stub**  engine)
{
    ...
    else if (enginename == "CO")
    {
        *engine = new ISKEngine_Stub_ME;
        ok = (engine != nullptr);
    }
	else
	{

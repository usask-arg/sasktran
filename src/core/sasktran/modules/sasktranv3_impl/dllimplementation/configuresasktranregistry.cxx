...
bool ConfigureSasktranIFEntries( const char* dllname, bool createentries)
{
    ...
    ok1 = ConfigureSasktranIFEntry ( "/SasktranIF/Engines/DO",										dllname, createentries); ok = ok && ok1;
    ok1 = ConfigureSasktranIFEntry ( "/SasktranIF/Engines/CO",										dllname, createentries); ok = ok && ok1;

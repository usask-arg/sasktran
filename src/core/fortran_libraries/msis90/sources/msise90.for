...
C-----------------------------------------------------------------------
      ...
      !DEC$ ATTRIBUTES DLLEXPORT:: GTD6
C      !DEC$ ATTRIBUTES ALIAS:"gtd6_" :: GTD6
...
C     ---- NDL303 Changed these codes as gfortran 95 didi not like character assignmnet to integers.
C     ---- The proper solution  would convert '12-M', 'Ar-9' and '0   ' into corresponding integers etc.
C     ---- I was lazy. Pretty sure it has no impact as this is just code identification stuff.
